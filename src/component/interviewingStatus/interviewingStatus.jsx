...
function InterviewingStatus() {
    ...
    useEffect(() => {
      ...
      const matchStatus = submission.status.toLowerCase() === "Interviewing" || submission.status.toLowerCase() === "interviewing";
...
export default InterviewingStatus